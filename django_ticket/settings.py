...
SECRET_KEY = 'django-insecure-c+@g=_fg*u2^7zftn3)loey*_$k+l$c!mwz@s5!!$!i=11c!6s'
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Rest API para Ticket',
    'DESCRIPTION': 'Esta es una API para aplicaciones de tickets',
    'VERSION': '1.0.0',
    'SERVE_INCLUDE_SCHEMA': False,
    'CONTACT': {
        'name': 'Soporte Técnico Ticket',
        'url': 'https://ticket.com/soporte',
        'email': 'soporte@ticket.com'
    },
    'LICENSE': {
        'name': 'MIT License',
    },
